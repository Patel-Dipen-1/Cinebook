...
-- All Tables with Sample Data for Movies, Comedy, Concerts
-- =====================================================
...
-- =====================================================
-- SAMPLE THEATRE ROWS DATA
-- =====================================================

-- Insert sample theatre rows for next 3 days
-- This will be populated by the application automatically
-- when users select specific shows
...
SELECT 'SmartShow Ultimate Database Setup Complete!' as status,
       'Total Tables: 10' as tables,
       'Total Theatres: 56' as theatres,
       'Total Movies: 40' as movies,
       'Total Comedy Shows: 5' as comedy_shows,
       'Total Concerts: 5' as concerts,
       'Total Venues: 10' as venues,
       'Admin User: admin/Admin@123' as admin_login,
       'Test User: test@gmail.com/Test@123' as test_user;