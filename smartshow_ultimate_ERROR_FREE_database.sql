-- =====================================================
-- SmartShow Ultimate - COMPLETE ERROR-FREE DATABASE SETUP
-- All Tables with Complete Sample Data - NO TUPLE ERRORS
-- =====================================================
...
('TXN1234567890', 1, 'test1@gmail.com', 700, 'UPI', 'SUCCESS', CURRENT_TIMESTAMP, 'test1@paytm'),
...
SELECT 'SmartShow Ultimate - ERROR-FREE DATABASE SETUP FINISHED!' as status,
       '✅ ALL DATA LOADED SUCCESSFULLY - NO TUPLE ERRORS!' as result;

SELECT 'TABLES CREATED' as category,
       COUNT(*) as count
FROM information_schema.tables 
WHERE table_schema = 'public';

SELECT 'Total Theatres' as item,
       COUNT(*) as count
FROM theatres
UNION ALL
SELECT 'Total Movies' as item,
       COUNT(*) as count
FROM movies
UNION ALL
...
SELECT '🎉 ERROR-FREE DATABASE SETUP COMPLETE - READY TO USE! 🎉' as final_message,
       '✅ NO TUPLE ERRORS - COMEDY & CONCERTS WORKING PERFECTLY!' as confirmation;