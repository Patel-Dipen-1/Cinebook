...
def get_movie_show_times(movie_id):
    """Get show times based on movie type - each movie has unique show times"""
    # Different show times for different movies to ensure variety
    movie_show_times = {
        # Romantic Movies - Evening focused
        ...
        # Action Movies - Multiple shows including late night
        6: ["12:30 PM", "4:00 PM", "7:30 PM", "10:45 PM"],
        7: ["12:15 PM", "3:45 PM", "7:15 PM", "10:30 PM"],
        8: ["12:45 PM", "4:15 PM", "7:45 PM", "11:00 PM"],
        9: ["1:00 PM", "4:30 PM", "8:00 PM", "11:15 PM"],
        10: ["12:00 PM", "3:30 PM", "7:00 PM", "10:15 PM"],
        
        # Comedy Movies - Afternoon and evening
        11: ["1:30 PM", "4:30 PM", "7:00 PM", "9:30 PM"],
        12: ["1:15 PM", "4:15 PM", "6:45 PM", "9:15 PM"],
        13: ["1:45 PM", "4:45 PM", "7:15 PM", "9:45 PM"],
        14: ["2:00 PM", "5:00 PM", "7:30 PM", "10:00 PM"],
        15: ["1:00 PM", "4:00 PM", "6:30 PM", "9:00 PM"],
        
        # Family Movies - Day shows and early evening
        16: ["11:00 AM", "2:30 PM", "6:00 PM", "9:00 PM"],
        17: ["10:45 AM", "2:15 PM", "5:45 PM", "8:45 PM"],
        18: ["11:15 AM", "2:45 PM", "6:15 PM", "9:15 PM"],
        19: ["10:30 AM", "2:00 PM", "5:30 PM", "8:30 PM"],
        20: ["11:30 AM", "3:00 PM", "6:30 PM", "9:30 PM"]
    }
...
def register_user():
    ...
    with st.form("register_form"):
        ...
        area = st.selectbox("Select Area:", [
            ...
            "Maninagar", "Naranpura", "Chandkheda", "Gota", "Sarkhej"
...
def movie_booking():
    ...
    st.write(f"### 🎬 {st.session_state.movie_mood} Movies")
    ...
    for movie in movies:
        with st.expander(f"🎬 {movie['movie_name']} ({movie['language']})"):
...
def movie_seat_selection():
    ...
    if not rows:
        st.error("❌ No seats available for this show time")
...
def comedy_booking():
    ...
    st.title("😂 Book Comedy Show Tickets")
    ...
    for show in shows:
        with st.expander(f"😂 {show['comedian_name']} - {show['show_title']}"):
            col1, col2 = st.columns([3, 1])
            with col1:
...
def comedy_venue_selection():
    """Venue selection for comedy shows"""
    ...
    # Get venues suitable for comedy shows
    cursor.execute("""
    ...
    for venue in venues:
        with st.expander(f"🏢 {venue['name']} - {venue['area']}"):
            col1, col2 = st.columns([3, 1])
            with col1:
...
def concert_booking():
    ...
    for concert in concerts:
        with st.expander(f"🎵 {concert['artist_name']} - {concert['concert_title']}"):
            col1, col2 = st.columns([3, 1])
            with col1:
...
def concert_venue_selection():
    ...
    # Get venues suitable for concerts
    cursor.execute("""
        SELECT venue_id, name, area, venue_type, capacity, available_capacity, base_price, address, facilities
    ...
    if payment_valid:
        ...
        with st.spinner("Processing payment..."):
            ...
            if success:
                ...
                st.info("🎫 Your ticket details have been saved to the appropriate file!")
    ...
    if not bookings:
        ...
        for booking in bookings:
            with st.expander(f"🎫 {booking['event_name']} - {booking['show_date']}"):
                ...
                with col2:
                    st.write(f"**Tickets:** {booking['booked_seats']}")
                    st.write(f"**Amount:** ₹{booking['total_amount']}")
